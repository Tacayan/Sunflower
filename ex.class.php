  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <div class="custom-file">
		<input type="file" class="" id="inputGroupFile04" name="photo" aria-describedby="inputGroupFileAddon04" required>
		<!-- <label class="custom-file-label" for="inputGroupFile04">Choose file</label>-->
	  </div>
	  <div class="input-group-append">
		<button class="btn btn-outline-secondary" type="submit" id="inputGroupFileAddon04">save photo</button>
	  </div>
	</div>
</form>
      </div>
	...
	public function addPhoto($codEx)
	{
